...
class Sudoku:
    ...
    def possible_solutions (self, row, col):
        solution_set = set(list(range(1,10)))                           # start with all solutions, then remove the invalid ones
        ...
        [remove_solution(each_row[col]) for each_row in self.board]     # remove numbers that already exist in the col
